...
employeetime = pd.read_excel('dailytph.xlsx')
...
timegap.to_excel('test.xlsx', index=False)

# Variable - dataframe to store excel file
timegap = pd.read_excel('test.xlsx')
...
# Save excel file
master_user.to_excel('cleaned.xlsx', index=False)

# Open cleaned file
master_user = pd.read_excel('cleaned.xlsx')
...
master_user.to_excel('cleaned2.xlsx', index=False)
